...
var mock_work_orders_1 = require("./mock-work-orders");
var WorkOrdersService = (function () {
    ...
    WorkOrdersService.prototype.getWorkOrders = function () {
        return Observable_1.Observable.create(function (observer) {
            observer.next(mock_work_orders_1.BARCHARTDATA);
        });
    };
    WorkOrdersService.prototype.fetchData = function () {
        return this.http.get('app/mock-work-orders.json')
            .map(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    WorkOrdersService.prototype.extractData = function (res) {
        var body = res.json();
        console.log('extractData() :');
        console.log(body.data);
        return body.data || {};
    };
    WorkOrdersService.prototype.handleError = function (error) {
        var errMsg;
